...
export default function Home() {
  return (
    <div className="h-100% w-100% max-h-[500px] max-w-[500px] pt-2 bg-gray-900 rounded-t-lg">
      <div className="mx-4 my-4 p-2 rounded-lg text-center text-slate-200 border-2 border-slate-200">
